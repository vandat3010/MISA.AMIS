    ...
    <div class="data" style="position: relative">
      ...
      >
        <thead>
          <tr>
            <th
              class="view-white pin"
              style="left: 0; top: 64px; z-index: 12"
            ></th>
            <th
              class="pin"
              style="
            ...
            <th class="fixed-top" style="min-width: 150px">MÃ NHÂN VIÊN</th>
            <th class="fixed-top" style="min-width: 250px">TÊN NHÂN VIÊN</th>
            <th class="fixed-top" style="min-width: 150px">GIỚI TÍNH</th>
            <th class="fixed-top" style="min-width: 150px">NGÀY SINH</th>
            <th class="fixed-top" style="min-width: 150px">SỐ CMND</th>
            <th class="fixed-top" style="min-width: 150px">CHỨC DANH</th>
            <th class="fixed-top" style="min-width: 200px">TÊN ĐƠN VỊ</th>
            <th class="fixed-top" style="min-width: 150px">SỐ TÀI KHOẢN</th>
            <th class="fixed-top" style="min-width: 150px">TÊN NGÂN HÀNG</th>
            <th class="fixed-top" style="min-width: 300px">
            ...
            <th
              class="view-white pin"
              style="right: 0; top: 64px; z-index: 11"
            ></th>
          </tr>
        </thead>
        ...
        .then(() => {
          getNewEmployeeCode()
            .then((data) => {
              ...
              this.$refs.employeeDialogRef.$refs.employeeCode.$el.focus();
            })
            .catch(() => {});
        })
        .catch(() => {});
